...
笔试流程 (可以使用 AI 辅助, 但请注明使用了 AI):

1. 和我们的 HR 建立联系.
2. 加入到专属的笔试飞书群.
3. 在飞书群中和 "需求方" 李用沟通, 实现一个小功能.
4. fork <https://github.com/zsqk/code-questions> 或者 <https://gitee.com/zsqk/code-questions>,
   将代码上传到 fork 后的仓库中.
5. 在飞书群中提交自己的 fork repo 地址.
